class Tutor extends Teacher
{
    ...
    public String setSalary(double newSalary,int newPerformanceIndex)
    {
        if(newPerformanceIndex>5 && getworkingHours()>20)
        {
            ...
            return("Salary has been successfully updated.");
        }
        else
        {
            return("The salary cannot be approved since Tutor has not been certified.");
        ...
        {
            return("Certified Tutor cannot be removed.");
        }
